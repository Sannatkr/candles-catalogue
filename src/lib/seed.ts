...
const tiers = (base: number): PriceTier[] => [
  { minQty: 1, price: base },
  { minQty: 10, price: Math.round((base * 0.92) / 5) * 5 },
  { minQty: 25, price: Math.round((base * 0.86) / 5) * 5 },
  { minQty: 50, price: Math.round((base * 0.79) / 5) * 5 },
  { minQty: 100, price: Math.round((base * 0.72) / 5) * 5 },
];
...
const drafts: Draft[] = [
  ...
  },
  {
    ...
    g: 380,
    price: 899,
    packaging: "Clear-lid gift box, sleeved",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    g: 320,
    price: 949,
    packaging: "Clear-lid gift box of 6",
  },
  {
